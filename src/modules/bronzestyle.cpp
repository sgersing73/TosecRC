...
{
    QPixmap backgroundImage(":/stylesheet/bronze/images/style/bronze/background.png");
        ...
        const QStyleOption *option, QPainter *painter) const
{
    ...
    if (option->state & (State_On | State_NoChange)) {
        ...
        if (!(option->state & State_Enabled)) {
            pixmap.load(":/stylesheet/bronze/images/style/bronze/checkmark-disabled.png");
        } else if (option->state & State_NoChange) {
            pixmap.load(":/stylesheet/bronze/images/style/bronze/checkmark-partial.png");
        } else {
            pixmap.load(":/stylesheet/bronze/images/style/bronze/checkmark.png");
        }
