...
set_target_properties(Qt5::WebKitWidgets PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/libQt5WebKitWidgets.dll.a"
  IMPORTED_LINK_DEPENDENT_LIBRARIES_RELEASE "Qt5::MultimediaWidgets;Qt5::PrintSupport"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libQt5WebKitWidgets.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS Qt5::WebKitWidgets )
list(APPEND _IMPORT_CHECK_FILES_FOR_Qt5::WebKitWidgets "${_IMPORT_PREFIX}/lib/libQt5WebKitWidgets.dll.a" "${_IMPORT_PREFIX}/bin/libQt5WebKitWidgets.dll" )
